...
shared_state_path = os.path.join(workdir, ".codex", "shared-state.md")
SHARED_STATE = ""
...
reuse_index_path = os.path.join(workdir, ".codex", "reuse-index.md")
REUSE_INDEX = ""
...
""" + (REUSE_INDEX or "(no .codex/reuse-index.md found — rely on project context and reference files)") + """
